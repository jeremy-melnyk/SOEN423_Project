...
public class ServerIDLHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, tam_replica.ServerInterfaceIDL.ServerIDL t)
    {
     ...
     */
    public static tam_replica.ServerInterfaceIDL.ServerIDL extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return tam_replica.ServerInterfaceIDL.ServerIDLHelper.narrow( a.extract_Object() );
        }
     ...
     */
    public static tam_replica.ServerInterfaceIDL.ServerIDL read(org.omg.CORBA.portable.InputStream istream)
    {
        return(tam_replica.ServerInterfaceIDL.ServerIDL)istream.read_Object(tam_replica.ServerInterfaceIDL._ServerIDLStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, tam_replica.ServerInterfaceIDL.ServerIDL value)
    {
