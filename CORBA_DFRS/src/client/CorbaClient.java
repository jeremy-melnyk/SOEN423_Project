...
public class CorbaClient {
	...
	protected final String FRONT_END_NAME = "DFRS";
	protected City city;
	...
	protected String[] getFlightRecords(){
		...
		return flightServer.getFlights();
	}
	...
	protected String[] getFlightReservations(){
		...
		return flightServer.getReservations();
	}
	...
	protected FlightReservationServer getFlightServer(){
		...
		try {
			...
			org.omg.CORBA.Object flightReservationServerRef = namingContextRef.resolve_str(FRONT_END_NAME);
