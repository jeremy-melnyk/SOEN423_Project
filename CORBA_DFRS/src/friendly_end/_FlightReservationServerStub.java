...
/**
* fe/_FlightReservationServerStub.java .
...
public class _FlightReservationServerStub extends org.omg.CORBA.portable.ObjectImpl implements friendly_end.FlightReservationServer
{
  ...
  public String[] getFlights ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = friendly_end.stringsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
