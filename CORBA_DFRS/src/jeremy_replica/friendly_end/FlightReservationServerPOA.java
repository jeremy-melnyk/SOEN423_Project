...
/**
* friendly_end/FlightReservationServerPOA.java .
...
public abstract class FlightReservationServerPOA extends org.omg.PortableServer.Servant
 implements jeremy_replica.friendly_end.FlightReservationServerOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // friendly_end/FlightReservationServer/bookFlight
       {
       ...
       case 1:  // friendly_end/FlightReservationServer/getBookedFlightCount
       {
       ...
       case 2:  // friendly_end/FlightReservationServer/editFlightRecord
       {
       ...
       case 3:  // friendly_end/FlightReservationServer/transferReservation
       {
       ...
       case 4:  // friendly_end/FlightReservationServer/getFlightRecords
       {
         String $result[] = null;
         $result = this.getFlightRecords ();
         out = $rh.createReply();
         jeremy_replica.friendly_end.stringsHelper.write (out, $result);
         break;
       }

       case 5:  // friendly_end/FlightReservationServer/getFlightReservations
       {
         String $result[] = null;
       ...
       case 6:  // friendly_end/FlightReservationServer/getPassengerRecords
       {
         String $result[] = null;
       ...
       case 7:  // friendly_end/FlightReservationServer/getManagerRecords
       {
         String $result[] = null;
  ...
  private static String[] __ids = {
    "IDL:friendly_end/FlightReservationServer:1.0"};
