...
public class SequencerTests {
	...
	public static void main(String[] args) {
		...
		int udpPort = jsonReader.getSequencerPort();
	...
	private static void testBookFlightOperation(int port) {
		...
		// Process the packet
		String result = processOperationPacket(packet, port);
	...
	private static String processOperationPacket(Packet packet, int port) {
