...
/**
* replica_friendly_end/stringsHelper.java .
...
{
  private static String  _id = "IDL:replica_friendly_end/strings:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (replica_friendly_end.stringsHelper.id (), "strings", __typeCode);
    }
    return __typeCode;
  }
