...
/**
* replica_friendly_end/_FlightReservationServerStub.java .
...
public class _FlightReservationServerStub extends org.omg.CORBA.portable.ObjectImpl implements replica_friendly_end.FlightReservationServer
{
  ...
  public String[] getFlightRecords ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = replica_friendly_end.stringsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
