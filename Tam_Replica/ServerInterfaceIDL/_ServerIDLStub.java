        ...
        implements ServerIDL
{
    ...
    private final static Class _opsClass = ServerInterfaceIDL.ServerIDLOperations.class;
    ...
    public String bookFlight(String firstName, String lastName, String Address, String phone, String destination, String date, String flightclass)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if (_so == null)
                   continue;
                ServerInterfaceIDL.ServerIDLOperations _self = (ServerInterfaceIDL.ServerIDLOperations) _so.servant;
                try
                {
